...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.txtSymbols.Text = global::Mono.Unix.Catalog.GetString ("BAC, C, CS, GS, JPM, MS, MSFT, IBM, MMM");
		this.txtSymbols.IsEditable = true;
		this.txtSymbols.InvisibleChar = '●';
		this.vbox4.Add (this.txtSymbols);
		global::Gtk.Box.BoxChild w1 = ((global::Gtk.Box.BoxChild)(this.vbox4 [this.txtSymbols]));
		w1.Position = 0;
		w1.Expand = false;
		w1.Fill = false;
		// Container child vbox4.Gtk.Box+BoxChild
		...
		this.btnQuote.Image = w2;
		this.vbox4.Add (this.btnQuote);
		global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(this.vbox4 [this.btnQuote]));
		w3.Position = 1;
		w3.Expand = false;
		w3.Fill = false;
		// Container child vbox4.Gtk.Box+BoxChild
		...
		global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.vbox2 [this.frame2]));
		w8.Position = 0;
		this.Add (this.vbox2);
		if ((this.Child != null)) {
			this.Child.ShowAll ();
